...
export class CreateProjectDto {
  ...
  @ApiProperty({ enum: ProjectStatus, required: false }) @IsEnum(ProjectStatus) @IsOptional() status?: ProjectStatus;
  @ApiProperty({ enum: Industry, required: false }) @IsEnum(Industry) @IsOptional() industry?: Industry;
